...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser?: { __typename?: 'User', id: string, profileImageURL?: string | null, firstName: string, email: string, lastName?: string | null } | null };
